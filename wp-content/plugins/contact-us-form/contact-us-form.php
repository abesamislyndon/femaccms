...
#contactsubmit {
 border-radius:4px; 
  ...
  vertical-align: top;
  color:#fff; 
  background-image: -ms-linear-gradient(bottom, #003399 0%, #0076AD 100%);
  background-image: -moz-linear-gradient(bottom, #003399 0%, #0076AD 100%);
  background-image: -o-linear-gradient(bottom, #003399 0%, #0076AD 100%);
  background-image: -webkit-gradient(linear, left bottom, left top, color-stop(0, #003399), color-stop(1, #0076AD));
  background-image: -webkit-linear-gradient(bottom, #003399 0%, #0076AD 100%);
  background-image: linear-gradient(to top, #003399 0%, #0076AD 100%);
  text-align:center
}
.cuf_field {
