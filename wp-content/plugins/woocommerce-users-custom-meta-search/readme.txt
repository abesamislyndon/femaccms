...
Tags: woocommerce, woothemes, e-store, eshop, ecommerce, e commerce, e-commerce, selling, wp-ecommerce, wp ecommerce
Tested up to 3.6
Stable Tag: 1.0

With this plugin you can add WooCommerce users meta fields to the WordPress default users search.
...
[Developer Website](http://remicorson.com)
...
1. The plugin settings within WooCommerce settings
